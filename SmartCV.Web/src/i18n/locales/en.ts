const en = {
  ...
  landing: {
    ...
    hero: {
      ...
      subheadline: 'Build a job-winning resume for free. No sign-up, no watermarks, no data leaving your device.',
  ...
  home: {
    ...
    emptySubtitle: 'Create, optimize, and tailor your resume with AI. Get matched to any job description instantly.',
  ...
  aiSettings: {
    ...
    subtitle: "API keys are stored securely in your browser's localStorage and never sent to our servers.",
