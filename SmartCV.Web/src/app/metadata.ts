...
export const SITE_URL = 'https://smart-cv.app';
export const SHARE_IMAGE_PATH = '/product.png';
...
const METADATA_BY_LOCALE: Record<AppLocale, LocaleMetadata> = {
  ...
  'zh-CN': {
    ...
    ogDescription:
      '使用 AI 优化、专业模板、本地优先隐私和可导出格式，创建 ATS 友好的简历。',
    keywords: [
      'AI 简历生成器',
      '免费简历生成器',
      'ATS 简历',
  ...
  'zh-TW': {
    ...
    ogDescription:
      '使用 AI 優化、專業模板、本地優先隱私與可匯出格式，建立 ATS 友善的履歷。',
    keywords: [
      'AI 履歷產生器',
      '免費履歷產生器',
      'ATS 履歷',
...
export function buildLandingMetadata(locale: AppLocale): Metadata {
  ...
  return {
    ...
    openGraph: {
      ...
      alternateLocale: Object.keys(LANGUAGE_ALTERNATES).filter(
